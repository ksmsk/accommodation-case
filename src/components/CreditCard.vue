  <template>
  <div class="card-item" v-bind:class="{ '-active': isFlipped }">
    <div class="card-item__side -front">
      ...
      <div class="card-item__cover">
        <img src="/images/card/background.jpeg" class="card-item__bg" />
      </div>

      <div class="card-item__wrapper">
        <div class="card-item__top">
          <img src="/images/card/chip.png" class="card-item__chip" />
          <div class="card-item__type">
            <transition name="slide-fade-up">
              <img
                v-bind:src="'/images/card/' + getCardType + '.png'"
                v-if="getCardType"
    ...
    <div class="card-item__side -back">
      ...
      <div class="card-item__cvv">
        ...
        <div class="card-item__cvvBand">
          <span v-for="(n, $index) in cardCvv" :key="$index"> {{ n }} </span>
        </div>
        <div class="card-item__type">
          <img
            v-bind:src="'/images/card/' + getCardType + '.png'"
